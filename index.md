...
#### 💼 Practice 
* Head of Software Development at <a href="https://www.hepster.com">hepster.com</a>, where I build a scalable, cloud-based insurance distribution platform. I helped the business by architecting and implementing a cloud-native infrastructure based on Spring Boot & Kotlin, AWS, Docker, Laravel, and Vue.js and coaching the delivery team. This also consisted of being a change agent to move the organisation from a project organisation to a strong product mindset (current).
